var adminGroup = {
    ...
    selectGroupChild: function (group_id = 0) {
        ...
        $.ajax({
            url: laroute.route('user.admin-group.get-list-child'),
            method: 'POST',
            data: {
    ...
    addGroupChild: function () {
        ...
        $.ajax({
            url: laroute.route('user.admin-group.add-collection-list-child'),
            method: 'POST',
            data: {
    ...
    showPopupUserList: function () {
        ...
        $.ajax({
            url: laroute.route('user.admin-group.get-list-user'),
            method: 'POST',
            data: {
    ...
    addUser: function () {
        ...
        $.ajax({
            url: laroute.route('user.admin-group.add-collection-list-user'),
            method: 'POST',
            data: {
                collection: collection
            },
    ...
    showPopupMenuList: function () {
        ...
        $.ajax({
            url: laroute.route('user.admin-group.get-list-menu'),
            method: 'POST',
            data: {
    ...
    addMenu: function () {
        ...
        $.ajax({
            url: laroute.route('user.admin-group.add-collection-list-menu'),
            method: 'POST',
            data: {
                collection: collection
            },
    ...
    showPopupActionList: function () {
        ...
        $.ajax({
            url: laroute.route('user.admin-group.get-list-action'),
            method: 'POST',
            data: {
    ...
    addAction: function () {
        ...
        $.ajax({
            url: laroute.route('user.admin-group.add-collection-list-action'),
            method: 'POST',
            data: {
                collection: collection
            },
    ...
    removeGroup: function (group_id) {
        $.getJSON(laroute.route('user.validation'), function (json) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: laroute.route('user.admin-group.destroy'),
                        method: 'POST',
                        data: {
                            group_id: group_id
                        },
    ...
    save: function (is_quit = 0) {
        ...
        $.getJSON(laroute.route('user.validation'), function (json) {
            ...
            if (form.valid()) {
                let url = ($('#group_id').length) ? laroute.route('user.admin-group.update') : laroute.route('user.admin-group.store')
                $.ajax({
                    url: url,
                    method: 'POST',
                    dataType: 'JSON',
                            ...
                            swal.fire(res.message, "", "success").then(function () {
                                if (is_quit === 0) {
                                    if ($('#group_id').length) {
                                        ...
                                        window.location.href = laroute.route('user.admin-group.create');
                                    }
                                } else {
                                    window.location.href = laroute.route('user.admin-group.index');
                                }
                            });
                        } else {
    ...
    addUserIntoGroup: function () {
        var form = $('#form-submit');
        $.ajax({
            url: laroute.route('user.admin-group.submit-add-user-into-group'),
            method: 'POST',
            dataType: 'JSON',
            data: form.serialize(),
            success: function (res) {
