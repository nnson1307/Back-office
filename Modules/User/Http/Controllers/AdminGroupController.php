...
use Modules\User\Http\Requests\AdminGroup\AdminGroupUpdateRequest;
...
use Modules\User\Http\Requests\AdminGroup\AdminGroupStoreRequest;
...
class AdminGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = $this->adminGroup->getListNew($filter);

        return view('user::admin-group.index', [
    ...
    public function create()
    {
        ...
        $listAdmin = $this->admin->getListAll(['is_admin' => 0]);
        $listMenu = $this->adminMenu->getListAll();

        return view('user::admin-group.create', [
    ...
    public function show($id)
    {
        ...
        if ($detail == null) {
            return redirect()->route('user.admin-group.index');
        }

        return view('user::admin-group.detail', [
            'detail' => $detail,
    ...
    public function edit($id)
    {
        ...
        return view('user::admin-group.edit', [
            'detail' => $detail,
            'admin_has_group' => $listUser,
            'list_action' => $listAction,
            'list_menu' => $listMenu
    ...
    public function destroy(Request $request)
    {
        ...
        if ($result) {
            return response()->json([
                'error' => 0,
                'message' => __('user::admin-group.destroy.IS_DELETED'),
            ]);
        } else {
            return response()->json([
                'error' => 0,
                'message' => __('user::admin-group.destroy.ERROR'),
            ]);
        }
    }
    ...
    public function addUserIntoGroup($group_id)
    {
        ...
        return view('user::admin-group.add-user-into-group', [
            'detail' => $detail,
            'admin_has_group' => $listUser,
        ]);
    }
    ...
    public function getListGroupChild(Request $request)
    {
        ...
        return view('user::admin-group.popup.popup-list-group-child', [
    ...
    public function addCollectionListGroupChild(Request $request)
    {
        ...
        return view('user::admin-group.partial.list-tr-group-child', [
            'list_group_child' => $listChild
        ]);
    }
    ...
    public function getListUser(Request $request)
    {
        ...
        return view('user::admin-group.popup.popup-list-user', [
            'list_user' => $listUser
        ]);
    }
    ...
    public function addCollectionListUser(Request $request)
    {
        ...
        return view('user::admin-group.partial.list-tr-user', [
            'list_user' => $listUser
        ]);
    }
    ...
    public function getListMenu(Request $request)
    {
        ...
        return view('user::admin-group.popup.popup-list-menu', [
            'list_menu' => $listMenu
        ]);
    }
    ...
    public function addCollectionListMenu(Request $request)
    {
        ...
        return view('user::admin-group.partial.list-tr-menu', [
            'list_menu' => $listMenu
        ]);
    }
    ...
    public function getListAction(Request $request)
    {
        ...
        return view('user::admin-group.popup.popup-list-action', [
            'list_action' => $listAction
        ]);
    }
    ...
    public function addCollectionListAction(Request $request)
    {
        ...
        return view('user::admin-group.partial.list-tr-action', [
            'list_action' => $listAction
        ]);
    }
}
