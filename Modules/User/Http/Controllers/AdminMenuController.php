...
use Modules\User\Http\Requests\AdminMenu\AdminMenuStoreRequest;
use Modules\User\Http\Requests\AdminMenu\AdminMenuUpdateRequest;
...
class AdminMenuController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = $this->adminMenu->getListNew($filter);
    ...
    public function show($id)
    {
        ...
        if ($detail == null) {
            return redirect()->route('user.admin-menu.index');
        }

        return view('user::admin-menu.detail', [
            'detail' => $detail,
    ...
    public function create()
    {
        ...
        return view('user::admin-menu.create', [
            'list_action' => $listAction,
            'list_icons' => $this->listIcons,
            'list_menu_category' => $listMenuCategory,
        ]);
    ...
    public function edit($id)
    {
        ...
        return view('user::admin-menu.edit', [
            'detail' => $detail,
            'list_action' => $listAction,
            'list_group' => $listGroup,
            'list_icons' => $this->listIcons,
    ...
    public function destroy(Request $request)
    {
        ...
        if ($result) {
            return response()->json([
                'error' => 0,
                'message' => __('user::admin-menu.destroy.IS_DELETED'),
            ]);
        } else {
            return response()->json([
                'error' => 0,
                'message' => __('user::admin-menu.destroy.ERROR'),
            ]);
        }
    }
    ...
    public function getListGroup(Request $request)
    {
        ...
        return view('user::admin-menu.popup.popup-list-group', [
    ...
    public function addCollectionList(Request $request)
    {
        ...
        return view('user::admin-menu.partial.list-tr-group', [
            'list_group' => $listChild
        ]);
    }
}
