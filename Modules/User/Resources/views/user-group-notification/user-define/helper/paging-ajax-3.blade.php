            ...
            @else
                <li class="kt-pagination__link--next">
                    <a title="First" class="m-datatable__pager-link m-datatable__pager-link--first"
                       href="javascript:void(0)" onclick="pageClick3(1)">
                ...
                <li class="kt-pagination__link--next">
                    <a title="Previous" class="m-datatable__pager-link m-datatable__pager-link--prev"
                       href="javascript:void(0)" onclick="pageClick3('{{$paginator->currentPage() - 1}}')">
                    ...
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="kt-pagination__link--active">
                                <a href="javascript:void(0)" onclick="pageClick3({{"$page"}})" title="{{ $page }}">{{ $page }}
                                </a>
                            </li>
                        @else
                            <li>
                                <a href="javascript:void(0)" onclick="pageClick3({{"$page"}})">
                                    {{ $page }}
                                </a>
                            </li>
                        @endif
            ...
            @else
                ...
                <li class="kt-pagination__link--last">
                    <a title="Last" class="m-datatable__pager-link m-datatable__pager-link--last"
                       href="javascript:void(0)" onclick="pageClick3('{{$paginator->lastPage()}}')">
