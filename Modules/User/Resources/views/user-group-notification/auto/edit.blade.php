    ...
    <div id="form-adds">
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    <span class="kt-subheader__title" id="kt_subheader_total">
                        @lang('user::user-group-notification.edit.EDIT_AUTO')
                                    </span>
                </h3>
            ...
            <div class="kt-subheader__toolbar">
                ...
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary" onclick="userGroupAuto.save('{{$id}}')">
                                        ...
                                        <div class="div-B-condition">
                                            @if(isset($userGroupDetail))
                                                ...
                                                @else
                                                    <div class="form-group row B-condition-1 div-B-1-condition">
                                                        <div class="col-lg-3">
                                                            <select onchange="userGroupAuto.chooseConditionB(this)"
                                                                    class="form-control select-2 ss-width-100pt condition-B">
                                                                @if(isset($filterConditionType))
                                                                    @foreach($filterConditionType as $item)
                                                                        <option value="{{$item['id']}}">
...
@section('after_script')
    ...
    <script src="{{asset('static/backend/js/user/user-group/edit.js?v='.time())}}" type="text/javascript"></script>
@stop
