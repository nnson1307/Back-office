    ...
    <div id="form-adds">
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    <span class="kt-subheader__title" id="kt_subheader_total">
                        @lang('user::user-group-notification.create.TITLE_AUTO')
                                    </span>
                </h3>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                <div class="kt-subheader__group" id="kt_subheader_search">
									<span class="kt-subheader__desc text-capitalize" id="kt_subheader_total">
										Trang chủ > Nhóm khách hàng > Tạo mới nhóm khách hàng động
                                    </span>
                </div>
            </div>
            <div class="kt-subheader__toolbar">
                ...
                <div class="btn-group">
                    <button type="submit" class="btn btn-primary" onclick="userGroupAuto.save(1)">
                        @lang('user::user-group-notification.create.SAVE_CHANGE_NEW')
                    </button>
                    <button type="submit" class="btn btn-primary" onclick="userGroupAuto.save(0)">
                                ...
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                                            ...
                                                            <div class="kt-widget14__legends ss--padding-left-0">
                                                                <div class="kt-widget14__legend">
                                                                    <span class="kt-widget14__stats kt-portlet__head-title" style="color: #656569;">
                                                                        0 @lang('user::user-group-notification.create.USER_INVALID')
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="form-group row kt-margin-l-0">
                                            ...
                                            <select name="A-or-and" id="A-or-and" class="form-control select-2 ss-width-100pt"
                                                    style="width: 15%">
                                                <option value="or">
                                        ...
                                        <div class="div-A-condition">
                                            <div class="form-group row A-condition-1 div-A-1-condition">
                                                <div class="col-lg-3">
                                                    <select onchange="userGroupAuto.chooseConditionA(this)"
                                        ...
                                        <div class="form-group row kt-margin-l-0">
                                            ...
                                            <select name="B-or-and" id="B-or-and" class="form-control select-2 ss-width-100pt"
                                                    style="width: 15%">
                                                <option value="or">
                                                    @lang('user::user-group-notification.create.OR')
                                                </option>
...
@section('after_script')
    <script type="text/template" id="condition-A-tpl">
        <div class="form-group row A-condition-1 div-A-1-condition">
            ...
            <div class="col-lg-6 div-content-condition">
                {{--<select name="" id="" class="form-control select-2 ss-width-100pt">--}}
                {{--@if(isset($myStoreFilterGroup))--}}
                {{--<option value="" selected>--}}
                {{--@lang('user::user-group-notification.create.CHOOSE_USER_GROUP_CREATED')--}}
                {{--</option>--}}
    ...
    <script type="text/template" id="condition-A-5-tpl">
        <div class="row">
            ...
            <div class="col-lg-4">
                <input type="text" im-insert="true" min="1" class="form-control day-A kt-margin-l-10 kt-margin-r-10" value="30">
            </div>
    ...
    <script src="{{asset('static/backend/js/user/user-group/add.js?v='.time())}}" type="text/javascript"></script>
@stop
