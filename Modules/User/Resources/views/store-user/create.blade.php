    ...
    <form id="form-register">
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">@lang('user::store-user.create.CREATE_STORE_USER')</h3>
        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            <div class="kt-portlet kt-portlet--tabs">
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('user::store-user.create.PASSWORD')</label>
                        <div class="col-lg-9 col-xl-9">
                            <input class="form-control" type="password" id="password" name="password"
                                   placeholder="@lang('user::store-user.create.PLACEHOLDER_PASSWORD')">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('user::store-user.create.PASSWORD_CONFIRM')</label>
                        <div class="col-lg-9 col-xl-9">
                            <input class="form-control" type="password" id="password_confirm" name="password_confirm"
                                   placeholder="@lang('user::store-user.create.PLACEHOLDER_PASSWORD_CONFIRM')">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-9">
                            <span class="kt-switch kt-switch--success">
                                <label>
                                    <input type="checkbox"
                                           checked id="is_activated" name="is_activated">
                                    <span></span>
                                </label>
                            </span>
                        </div>
...
@section('after_script')
    <script>
        ...
        var create_success = '@lang('user::store-user.create.CREATE_SUCCESS')';
        var create_fail = '@lang('user::store-user.create.CREATE_FAIL')';
        //Validate
