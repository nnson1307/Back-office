            ...
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        @lang('user::admin-menu.index.SHOW_ADMIN_MENU')
                    </h3>
                ...
                <div class="kt-subheader__toolbar">
                    @if (in_array('user.admin-menu.edit', request()->session()->get('user_route'))
                    || Auth::user()->is_admin)
                        <a href="{{ route('user.admin-menu.edit', ['id' => $detail['menu_id']]) }}" class="btn btn-info btn-bold">
                            @lang('user::admin-menu.input.BUTTON_EDIT')
                        </a>
                    @endif
                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-9">
                            <input type="text" class="form-control" value="{{ $detail['menu_name'] }}" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                        ...
                        <div class="col-lg-9 col-xl-9">
                            <textarea class="form-control" name="description" id="description" rows="1" disabled>{{ $detail['description'] }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                ...
                <div class="kt-portlet__body">
                    <div class="kt-section">
                        <table class="table table-striped" id="table-admin-group">
                            <thead>
                            <tr>
                                <th>@lang('user::admin-menu.create.ADMIN_GROUP_NAME')</th>
                                <th>@lang('user::admin-menu.create.ADMIN_GROUP_DESCRIPTION')</th>
                            </tr>
                            </thead>
                            <tbody>
