...
@section('content')
    @if (isset($detail))
        <form id="form-submit" method="POST" action="{{ route('user.admin-menu.update') }}">
            {{ csrf_field() }}
            <input type="hidden" name="menu_id" id="menu_id" value="{{ $detail['menu_id'] }}">
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">
                        @lang('user::admin-menu.index.EDIT_ADMIN_MENU')
                    </h3>
                ...
                <div class="kt-subheader__toolbar">
                    <button type="button" class="btn btn-info btn-bold" onclick="adminMenu.save(1)">
                        @lang('user::admin-menu.input.BUTTON_SAVE')
                    </button>
                    @include('helpers.button', ['button' => [
                        'route' => 'user.admin-menu.create',
                        'html' => '<a href="'.route('user.admin-menu.create').'" class="btn btn-label-brand btn-bold">'
                        .__('user::admin-menu.input.BUTTON_ADD_NEW').
                    '</a>'
                    ]])
                    @include('helpers.button', ['button' => [
                        'route' => 'user.admin-menu.destroy',
                        'html' => '<a href="javascript:void(0)" class="btn btn-danger btn-bold" onclick="adminMenu.removeMenu('.$detail['menu_id'].')">'
                        .__('user::admin-menu.input.BUTTON_REMOVE').
                    '</a>'
                    ]])
                    <a href="{{route('user.admin-menu.index')}}" class="btn btn-secondary btn-bold">
                        @lang('user::admin-menu.input.BUTTON_CANCEL')
                    </a>
                </div>
            </div>
                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                            @lang('user::admin-menu.edit.ADMIN_MENU_NAME')
                        </label>
                        <div class="col-lg-9 col-xl-9">
                            <input class="form-control{{ $errors->has('menu_name') ? ' is-invalid' : '' }}"
                                   ...
                                   placeholder="@lang('user::admin-menu.input.PLACEHOLDER_NAME')" required>
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                            @lang('user::admin-menu.edit.ADMIN_MENU_DESCRIPTION')
                        </label>
                        <div class="col-lg-9 col-xl-9">
                            <textarea class="form-control" placeholder="@lang('user::admin-menu.input.PLACEHOLDER_DESCRIPTION')"
                                      name="description" id="description" rows="1">{{ old('description', isset($detail['description']) ? $detail['description'] : null) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                            @lang('user::admin-menu.edit.ADMIN_MENU_POSITION')
                        </label>
                        <div class="col-lg-9 col-xl-9">
                            <input class="form-control{{ $errors->has('menu_position') ? ' is-invalid' : '' }}" type="number"
                                   ...
                                   placeholder="@lang('user::admin-menu.input.PLACEHOLDER_POSITION')">
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                            @lang('user::admin-menu.create.ADMIN_MENU_ACTION')
                        </label>
                        <div class="col-lg-9 col-xl-9">
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                            @lang('user::admin-menu.create.ADMIN_MENU_CATEGORY')
                        </label>
                        <div class="col-lg-9 col-xl-9">
                            <select class="form-control select2" name="menu_category_id">
                                <option value="0"
                                        {{ ($detail['menu_category_id'] == 0) ? ' selected' : ''}}>
                                    @lang('user::admin-menu.input.PLACEHOLDER_MENU_CATEGORY')
                                </option>
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                            @lang('user::admin-menu.create.ADMIN_MENU_ICON')
                        </label>
                        <div class="col-lg-9 col-xl-9">
                            <div class="row">
            ...
            <div class="kt-portlet kt-portlet--tabs">
                <div class="kt-portlet__body">
                    <div class="kt-section">
                        @include('user::admin-menu.partial.list-admin-group')
                    </div>
                </div>
            </div>
        </form>
