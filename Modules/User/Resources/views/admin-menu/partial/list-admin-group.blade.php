<table class="table table-striped" id="table-admin-group">
            ...
            <tr class="group-item">
                ...
                <td>
                    <select class="form-control" onchange="adminMenu.removeRow(this)">
                        ...
                        <option value="1">@lang('user::admin-menu.index.TABLE_REMOVE')</option>
                    </select>
                </td>
            </tr>
        @endforeach
    ...
    <tr id="row-btn-add">
        <td colspan="3">
            <a href="javascript:void(0)" onclick="adminMenu.showPopupAdminGroup()">
                @lang('user::admin-menu.input.BUTTON_ADD')
            </a>
        </td>
    </tr>
    </tbody>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        @lang('user::admin-menu.create.ADD_ADMIN_GROUP')
                    </h5>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">
                        @lang('user::admin-menu.input.BUTTON_CLOSE')
                    </button>
                    <button type="button"
                            id="btn-add-group-to-list"
                            class="btn btn-primary"
                            onclick="adminMenu.addGroup()"
                    >
                        @lang('user::admin-menu.input.BUTTON_ADD')
                    </button>
                </div>
