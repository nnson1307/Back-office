...
@endsection
@section('content')
    <form id="form-submit" method="POST" action="{{ route('user.admin-menu.store') }}">
        {{ csrf_field() }}
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    @lang('user::admin-menu.index.CREATE_ADMIN_MENU')
                </h3>
            ...
            <div class="kt-subheader__toolbar">
                <button type="button" class="btn btn-info btn-bold" onclick="adminMenu.save()">
                    @lang('user::admin-menu.input.BUTTON_SAVE_CREATE')
                </button>
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">
                        @lang('user::admin-menu.create.ADMIN_MENU_NAME')
                    </label>
                ...
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">
                        @lang('user::admin-menu.create.ADMIN_MENU_DESCRIPTION')
                    </label>
                    <div class="col-lg-9 col-xl-9">
                        <textarea class="form-control" placeholder="@lang('user::admin-menu.input.PLACEHOLDER_DESCRIPTION')"
                                  name="description" id="description" rows="1">{{ old('description') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-xl-3 col-lg-3 col-form-label">
                        @lang('user::admin-menu.create.ADMIN_MENU_POSITION')
                    </label>
                    <div class="col-lg-9 col-xl-9">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-9">
                        <select class="form-control select2" name="menu_category_id">
                            <option value="0">@lang('user::admin-menu.input.PLACEHOLDER_MENU_CATEGORY')</option>
