<div class="row">
    <div class="form-group col-lg-3">
        <input class="form-control" type="text" id="keyword_admin_action$action_name"
               ...
               placeholder="@lang('user::admin-group-action.index.ADMIN_ACTION_NAME')"
    ...
    <div class="form-group col-lg-3">
        <input class="form-control" type="text" id="keyword_adgn$action_group_name"
               ...
               placeholder="@lang('user::admin-group-action.index.ADMIN_ACTION_GROUP_NAME')"
    ...
    <div class="form-group col-lg-3">
        <input class="form-control" type="text" id="keyword_admin_action$description"
               ...
               placeholder="@lang('user::admin-group-action.index.ADMIN_ACTION_DESCRIPTION')"
    ...
    <div class="form-group col-lg-3">
        <input class="form-control" type="text" id="keyword_admin_action$action_name_default"
               ...
               placeholder="@lang('user::admin-group-action.index.ADMIN_ACTION_NAME_DEFAULT')"
               value="{{$filter['keyword_admin_action$action_name_default'] != null?$filter['keyword_admin_action$action_name_default'] : ''}}">
    </div>
    <div class="form-group col-lg-3">
        <a class="btn btn-secondary btn-hover-brand" href="{{route('user.admin-group-action.index')}}">
            @lang('user::admin-group-action.input.BUTTON_REMOVE')
        </a>
        <button type="submit" class="btn btn-primary btn-hover-brand">
            @lang('user::admin-group-action.input.BUTTON_SEARCH')
        </button>
    </div>
</div>
