...
@endsection
@section('content')
    <form id="form-submit" method="POST" action="{{ route('user.admin-menu-category.store') }}">
        {{ csrf_field() }}
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">
                    @lang('user::admin-menu-category.index.CREATE_ADMIN_MENU_CATEGORY')
                </h3>
            ...
            <div class="kt-subheader__toolbar">
                <button type="button" class="btn btn-info btn-bold" onclick="adminMenuCategory.save()">
                    @lang('user::admin-menu-category.input.BUTTON_SAVE_ADD_NEW')
                </button>
