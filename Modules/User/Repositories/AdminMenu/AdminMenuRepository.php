...
class AdminMenuRepository implements AdminMenuRepositoryInterface
{
    ...
    public function getListNew(array $filters = [])
    {
        ...
        $listAdminMenu = $this->adminMenu->getListNew($filters);
    ...
    public function add(array $data)
    {
        try {
            ...
            return [
                'error' => 0,
                'message' => __('user::admin-menu.create.SUCCESS'),
                'menu_id' => $menu_id
            ];
        } catch (\Exception $e) {
            DB::rollBack();
            return [
                'error' => 1,
                'message' => __('user::admin-menu.create.FAILED'),
            ];
        }
    }
    ...
    public function edit(array $data)
    {
        try {
            ...
            return [
                'error' => 0,
                'message' => __('user::admin-menu.edit.SUCCESS'),
                'menu_id' => $menu_id
            ];
        } catch (\Exception $e) {
            DB::rollBack();
            return [
                'error' => 1,
                'message' => __('user::admin-menu.edit.FAILED'),
            ];
        }
    }
