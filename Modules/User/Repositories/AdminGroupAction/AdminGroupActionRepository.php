...
namespace Modules\User\Repositories\AdminGroupAction;
...
class AdminGroupActionRepository implements AdminGroupActionRepositoryInterface
{
    ...
    public function edit(array $data)
    {
        try {
            ...
            return [
                'error' => 0,
                'message' => __('user::admin-group-action.edit.UPDATED')
            ];
        } catch (\Exception $e) {
            DB::rollBack();
            return [
                'error' => 1,
                'message' => __('user::admin-group-action.edit.UPDATE_FAILED')
            ];
        }
    }
