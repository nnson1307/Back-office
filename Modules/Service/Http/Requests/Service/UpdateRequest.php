...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'service_name_vi' => 'required|max:250|unique:admin_service,service_name_vi,'.$serviceId.',service_id',
            'service_name_en' => 'required|max:250|unique:admin_service,service_name_en,'.$serviceId.',service_id',
