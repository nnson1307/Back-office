    ...
    <form id="form-register">
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">@lang('service::service.index.SERVICE_EDIT') - {{$detail['service_name_vi']}}</h3>
            ...
            <div class="kt-subheader__toolbar">
                <button type="button" class="btn btn-info btn-bold" onclick="update.submit_index()">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control" id="service_name_vi" name="service_name_vi" type="text" maxlength="250"
                                           placeholder="@lang('service::service.create.SERVICE_NAME_PLACEHOLDER') VI" value="{{$detail['service_name_vi']}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control" id="service_name_en" name="service_name_en" type="text" maxlength="250"
                                           placeholder="@lang('service::service.create.SERVICE_NAME_PLACEHOLDER') EN" value="{{$detail['service_name_en']}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                    ...
                                    <span class="kt-switch kt-switch--success">
                                        <label>
                                            <input type="checkbox" class="switch-publish"
                                                   id="is_actived" name="is_actived" {{$detail['is_actived'] == 1 ? "checked" :""}}>
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control" type="text" id="description" name="description" value="{{$detail['description_short']}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <textarea class="form-control" rows="10" id="img_content" name="img_content">{!! $detail['description'] !!}</textarea>
                                </div>
                            </div>
        ...
        <input type="hidden" value="{{$detail['service_id']}}" id="service_id">
    </form>
...
@section('after_script')
    <script>
        ...
        var service_edit_fail = "@lang('service::validation.service.service_edit_fail')";
        var service_create_success = "@lang('service::validation.service.service_create_success')";
        var service_edit_success = "@lang('service::validation.service.service_edit_success')";
