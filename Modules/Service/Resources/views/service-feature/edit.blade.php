    ...
    <form id="form-register">
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            ...
            <div class="kt-subheader__toolbar">
                <button type="button" class="btn btn-info btn-bold" onclick="updateFeature.submit_index()">
                    @lang('service::service.index.EDIT_CLOSE')
                </button>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control" id="feature_group_name_vi" value="{{$detail['feature_group_name_vi']}}" type="text" maxlength="250"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control" id="feature_group_name_en" value="{{$detail['feature_group_name_en']}}" type="text" maxlength="250"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control" id="feature_group_name_redefine" name="feature_group_name_redefine" value="{{$detail['feature_group_name_redefine']}}" type="text" maxlength="250"
                                           placeholder="@lang('service::service_feature.index.feature_name_redefine')" >
                                </div>
                            </div>
                            <div class="form-group row">
                                    ...
                                    <span class="kt-switch kt-switch--success">
                                        <label>
                                            <input type="checkbox" class="switch-publish"
                                                   id="is_actived" {{$detail['is_actived'] == 1 ? "checked" : ""}} disabled>
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input class="form-control" type="text" id="description_short" name="description_short" value="{{$detail['description_short']}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <textarea class="form-control" rows="10" name="description" id="img_content">{{$detail['description']}}</textarea>
                                </div>
                            </div>
        ...
        <input type="hidden" value="{{$detail['feature_group_id']}}" id="feature_group_id">
    </form>
@stop
@section('after_script')
    <script>
        ...
        var redefine_required = "@lang('service::service_feature.validate.redefine_required')";
        var redefine_max = "@lang('service::service_feature.validate.redefine_max')";
        var feature_edit_success = "@lang('service::service_feature.validate.feature_edit_success')";
        var feature_edit_fail = "@lang('service::service_feature.validate.feature_edit_fail')";
        var short_des_max = "@lang('service::service_feature.validate.short_des_max')";
    </script>
