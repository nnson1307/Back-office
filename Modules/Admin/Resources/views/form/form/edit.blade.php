...
@section('header')
    @include('components.header',['title'=>__('admin::form.form.index.edit-form')])
@endsection
@section('after_style')
...
@section('content')
    <form id="form-create" enctype="multipart/form-data">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">@lang('admin::form.form.index.edit-form')</h3>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                <div class="kt-subheader__group" id="kt_subheader_search">
                ...
                <div class="kt-portlet__body" style="border-bottom: 1px solid #ebedf2;">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <input class="form-control" id="feedback_form_name" name="feedback_form_name" type="text" value="{{$detail['feedback_form_name']}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <textarea class="form-control" id="feedback_form_description" name="feedback_form_description" type="text">{{$detail['feedback_form_description']}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <input class="form-control" id="feedback_form_rating_min" name="feedback_form_rating_min" type="text" value="{{$detail['feedback_form_rating_min']}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('admin::form.form.index.rating_max') <span class="text-danger">(*)</span></label>
                        <div class="col-lg-6 col-xl-6">
                            <input class="form-control" id="feedback_form_rating_max" name="feedback_form_rating_max" type="text" value="{{$detail['feedback_form_rating_max']}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                        ...
                        <span class="kt-switch kt-switch--success">
                            <label>
                                <input type="checkbox" name="feedback_form_active" id="feedback_form_active" {{$detail['feedback_form_active'] == 1 ? "checked" : ""}} >
                                <span></span>
                            </label>
                        </span>
                        </div>
        ...
        <input type="hidden" id="feedback_form_id" name="feedback_form_id" type="text" value="{{$detail['feedback_form_id']}}" disabled>
    </form>
@endsection
