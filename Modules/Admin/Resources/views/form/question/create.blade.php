...
@section('header')
    @include('components.header',['title'=>__('admin::form.form.index.create-question')])
@endsection
@section('content')
    <form id="form-create" enctype="multipart/form-data">
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">@lang('admin::form.question.index.create-question')</h3>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                <div class="kt-subheader__group" id="kt_subheader_search">
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <select name="feedback_form_id" id="feedback_form_id" class="form-control --select2">
                                @foreach($getListForm as $form)
                                    <option value="{{$form['feedback_form_id']}}">{{$form['feedback_form_name']}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
{{--                                <option value="rating">@lang('admin::form.question.index.rating')</option>--}}
{{--                                <option value="comment">@lang('admin::form.question.index.comment')</option>--}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <textarea class="form-control" id="feedback_question_title" name="feedback_question_title" type="text"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('admin::form.question.index.question_position')</label>
                        <div class="col-lg-6 col-xl-6">
                            <input class="form-control" id="feedback_question_position" name="feedback_question_position" type="text" >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">
                        ...
                        <span class="kt-switch kt-switch--success">
                            <label>
                                <input type="checkbox" name="feedback_question_active" id="feedback_question_active" checked>
                                <span></span>
                            </label>
                        </span>
                        </div>
