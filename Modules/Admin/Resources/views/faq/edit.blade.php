...
@section('content')
    @if (isset($detail))
        <form action="{{ route('admin.faq.update') }}" method="POST" id="form-submit">
            {{ csrf_field() }}
            <input type="hidden" name="faq_id" value="{{ $detail['faq_id'] }}" id="faq_id">
            <div class="kt-subheader kt-grid__item" id="kt_subheader">
                <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">@lang('admin::faq.index.EDIT_FAQ')</h3>
                ...
                <div class="kt-portlet kt-portlet--tabs">
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <input type="text" maxlength="250"
                                       ...
                                       value="{{ old('faq_title', isset($detail) ? $detail['faq_title'] : null) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <select name="faq_group" id="faq_group" class="form-control select2">
                                    ...
                                    @if (isset($listFaqGroup) && count($listFaqGroup) > 0)
                                        @foreach ($listFaqGroup as $item)
                                            <option value="{{ $item['faq_group_id'] }}"
                                                    {{ old('faq_group', isset($detail) ? $detail['faq_group'] : null) == $item['faq_group_id'] ? 'selected' : '' }}
                                            >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <input type="number" min="1"
                                       ...
                                       value="{{ old('faq_position', isset($detail['faq_position']) ? $detail['faq_position'] : null) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <textarea id="faq_content" name="faq_content" rows="20">{{ $detail['faq_content'] }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
