    ...
    <form id="form-update">
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">@lang('admin::ward.index.DETAIL_WARD')</h3>
            ...
            <div class="kt-subheader__toolbar">
                @include('helpers.button', ['button' => [
                        ...
                        'html' => '<a href="'.route('admin.ward.edit', ['id' => $ward['ward_id']]).'" class="btn btn-info btn-bold">'
                ...
                @include('helpers.button', ['button' => [
                    ...
                    'html' => '<a href="javascript:void(0)" class="btn btn-danger btn-bold" onclick="remove.click('.$ward['ward_id'].')">'
            ...
            <div class="kt-portlet kt-portlet--tabs">
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('admin::ward.edit.COUNTRY')</label>
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('admin::ward.edit.PROVINCE')</label>
                        <div class="col-lg-9 col-xl-9">
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('admin::ward.edit.DISTRICT')</label>
                        <div class="col-lg-9 col-xl-9">
                            <select disabled class="form-control" id="district_id" name="district_id" style="width: 100%;">
                                <option></option>
...
{{--                                @endforeach--}}
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('admin::ward.edit.WARD_NAME')</label>
                        <div class="col-lg-9 col-xl-9">
                    ...
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('admin::ward.edit.WARD_CODE')</label>
                        <div class="col-lg-9 col-xl-9">
                            <input disabled class="form-control" type="text" id="ward_code" name="ward_code"
                                   placeholder="@lang('admin::ward.edit.PLACE_HOLDER_WARD_CODE')" value="{{$ward['ward_code']}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-xl-3 col-lg-3 col-form-label">@lang('admin::ward.edit.TYPE')</label>
                        <div class="col-lg-9 col-xl-9">
