@php
    ...
    $selected = (isset($_GET['perpage'])) ? $_GET['perpage'] : 50;
    ...
    @if ($paginator->hasPages())
        <ul class="kt-pagination__links">
                    ...
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <li class="kt-pagination__link--active">
                                <a data-page="{{$page}}" href="{{$url}}" title="{{ $page }}">{{ $page }}</a></li>
                        @else
            ...
            @else
                ...
                <li class="kt-pagination__link--last">
                    <a data-page="{{$paginator->lastPage()}}" title="Last" class="m-datatable__pager-link m-datatable__pager-link--last"
