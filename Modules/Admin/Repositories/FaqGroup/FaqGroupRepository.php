...
class FaqGroupRepository implements FaqGroupRepositoryInterface
{
    ...
    {
        if (!isset($filters['sort_faq_group$faq_group_title'])) {
            $filters['sort_faq_group$faq_group_title'] = null;
        }

        if (!isset($filters['sort_fgrparent$faq_group_title'])) {
            $filters['sort_fgrparent$faq_group_title'] = null;
        }

        if (!isset($filters['sort_faq_group$faq_group_position'])) {
            $filters['sort_faq_group$faq_group_position'] = null;
        }

        if (!isset($filters['sort_faq_group$is_actived'])) {
            $filters['sort_faq_group$is_actived'] = null;
        }

        if (!isset($filters['keyword_faq_group$faq_group_title'])) {
            $filters['keyword_faq_group$faq_group_title'] = null;
        }

        if (!isset($filters['keyword_fgrparent$faq_group_title'])) {
            $filters['keyword_fgrparent$faq_group_title'] = null;
        }

        if (!isset($filters['keyword_faq_group$is_actived'])) {
            $filters['keyword_faq_group$is_actived'] = null;
        }
        ...
        if (count($check) == 0) {
            $filters['sort_faq_group$faq_group_title'] = 'asc';
        }
    ...
    public function add(array $data)
    {
        try {
            $dataFaqGroup = [
                ...
                'faq_group_title' => strip_tags($data['faq_group_title']),
