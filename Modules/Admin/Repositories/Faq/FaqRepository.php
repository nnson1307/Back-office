...
class FaqRepository implements FaqRepositoryInterface
{
    ...
    public function __construct(FaqTable $faq)
    {
        $this->faq = $faq;
    }
    ...
    public function getListNew(array $filters = [])
    {
        ...
        if (!isset($filters['sort_fgr$faq_group_title'])) {
            $filters['sort_fgr$faq_group_title'] = null;
        }
    ...
    {
        $result = $this->faq->getListAll($filters)->toArray();
    ...
    public function add(array $data, $faqType = 'faq')
    {
        try {
            $dataFaq = [
                'faq_title' => strip_tags($data['faq_title']),
